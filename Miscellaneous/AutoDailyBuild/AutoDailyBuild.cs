// $Id: AutoDailyBuild.cs 1388 2007-07-03 20:44:50Z fred $
...
namespace AutoDailyBuild {
    ...
    class AutoDailyBuild {
        ...
        static void Main(string[] args) {
            ...
            string pathToSVNBIN = @"C:\Program Files\Subversion\bin\svn.exe";
            string pathToSVNVERSIONBIN = @"c:\Program Files\Subversion\bin\svnversion.exe";
            string emailFrom = "fred@cs.washington.edu";
            string emailTo = "presenter-dev@cs.washington.edu";
...
//            //Delete the old log file, if it exists
            ...
            */
            try {
                ...
                AutoDailyBuild.SendEmail(emailServer, emailFrom, emailTo, subject, body, "");
                return;
            }
            ...
            if (resultLocation < 0) {
                ...
                AutoDailyBuild.SendEmail(emailServer, emailFrom, emailTo, subject, body, drive + pathToSVNROOT + "\\builds\\buildresult.log");
                return;
            }
                    ...
                    */
                    ...
                    try {
                        ...
                        if (lastv + 1 == currentv) {
                            ...
                            //CHANGE 2006/2/14 by Peter: Don't send the "SKIPPED" email, because it's annoying.
