// $Id: RoleSynchronizer.cs 1131 2006-08-16 18:29:59Z fred $
        ...
        private void onRoleChange(object sender, PropertyEventArgs e) {
            using(Synchronizer.Lock(this.m_Participant.SyncRoot)) {
                ...
                using(Synchronizer.Lock(this.m_SlideViewer.SlideDisplay.SyncRoot)) {
                    ...
                    if (this.m_Participant.Role is Model.Network.InstructorModel) {
                    ...
                    } else if (this.m_Participant.Role is Model.Network.StudentModel) {
                    ...
                    } else if (this.m_Participant.Role is Model.Network.PublicModel) {
