// $Id: SaveDeckDialog.cs 1678 2008-08-05 21:07:10Z lining $
...
namespace UW.ClassroomPresenter.Decks {
    public class SaveDeckDialog {
        ...
        public void SaveDeck(IWin32Window window) {
            ...
            save.Filter = "CP3 files (*.cp3)|*.cp3|PPTX files (*.pptx)|*.pptx|All Files (*.*)|*.*";           
            if (save.ShowDialog() == DialogResult.OK) {
                ...
                else if (save.FilterIndex != 1 && !save.FileName.EndsWith(".pptx")){
                    save.FileName = save.FileName + ".pptx";
                }
