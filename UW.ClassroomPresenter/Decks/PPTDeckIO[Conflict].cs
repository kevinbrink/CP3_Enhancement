// $Id: PPTDeckIO.cs 1588 2008-04-05 17:35:59Z cmprince $
...
namespace UW.ClassroomPresenter.Decks {
    ...
    public class PPTDeckIO {
        ...
        private static SlideModel CreateSlide(PowerPoint.PageSetup pageSetup, PPTPaneManagement.PPTPaneManager pptpm, DeckModel deck, TempFileCollection tempFileCollection, string dirpath, PowerPoint._Slide currentSlide) {
            ...
            CustomXMLNodes answrs = (CustomXMLNodes)pollXML.SelectNodes("/CP3Poll/PollAnswers");
            ...
            CustomPoll poll = new CustomPoll(pollXML.SelectSingleNode("/CP3Poll/PollQuestion").Text, pollXML.SelectSingleNode("/CP3Poll/PollType").Text, Convert.ToInt32(pollXML.SelectSingleNode("/CP3Poll/PollSlide").Text),
                pollXML.SelectSingleNode("/CP3Poll/PollCorrectAnswer").Text);
        ...
        private static List<TaggedShape> BuildTaggedShapeList(PowerPoint.Shapes shapes, PPTPaneManagement.PPTPaneManager pptpm) {
            ...
            for (int i = 1; i <= shapes.Count; i++) {
                ...
                if( shape.Type == Microsoft.Office.Core.MsoShapeType.msoGroup && !((PowerPoint.Application)shapes.Application).Version.Equals("12.0")) {
                    shape.Ungroup();
                    i--;
                    continue;
                } else
...
*/
        ...
        public static void SaveAsCP3(FileInfo file, DeckModel in_deck) {
            ...
            if (deck.Disposition == DeckDisposition.Remote) {
