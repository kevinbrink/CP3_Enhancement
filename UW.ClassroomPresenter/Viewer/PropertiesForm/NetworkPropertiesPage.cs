// $Id: NetworkPropertiesPage.cs 1698 2008-08-12 00:00:06Z lamphare $
...
namespace UW.ClassroomPresenter.Viewer.PropertiesForm {
    ...
    public class NetworkPropertiesPage : TabPage {
        ...
        public NetworkPropertiesPage(ViewerStateModel vsm) {
            ...
            // Add the controls
            this.Controls.Add(new BeaconIntervalLabel(new Point(16, 16), new Size(150, 32), 0));
            this.Controls.Add(new BeaconIntervalUpDown(vsm, new Point(168, 16), new Size(56, 20), 1));
            this.Controls.Add(new BeaconIntervalUnitsLabel(new Point(232, 16), new Size(48, 23), 2));
            this.Controls.Add(new PacketDelayLabel(new Point(16, 56), new Size(150, 32), 3));
            this.Controls.Add(new PacketDelayUpDown(vsm, new Point(168, 56), new Size(56, 20), 4));
            this.Controls.Add(new PacketDelayUnitsLabel(new Point(232, 56), new Size(24, 23), 5));
            this.Controls.Add(new FECLabel(new Point(16, 88), new Size(150, 32), 6));
            this.Controls.Add(new FECUpDown(vsm, new Point(168, 88), new Size(56, 20), 7));
            this.Controls.Add(new FECUnitsLabel(new Point(232, 88), new Size(48, 16), 8));
            this.Controls.Add(new BroadcastDisabledCheckBox(vsm, new Point(16, 128), new Size(250, 20), 9));
