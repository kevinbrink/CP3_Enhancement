// $Id: PenPropertiesPage.cs 1700 2008-08-12 00:08:12Z lamphare $
...
namespace UW.ClassroomPresenter.Viewer.PropertiesForm {
    ...
    public class PenPropertiesPage : Form {
        ...
        public PenPropertiesPage(PenStateModel psm, DrawingAttributes atts, bool isPen) {
            ...
            // Add the controls
            this.Controls.Add(new PenTypeGroupBox(this, new Point(12, 8), new Size(164, 64), 0));
            this.Controls.Add(new PenShapeGroupBox(this, new Point(12, 72), new Size(164, 64), 1));
            this.Controls.Add(new PenColorGroupBox(this, new Point(12, 136), new Size(164, 48), 2));
            ...
            this.Controls.Add(new UndoChangesButton(this, new Point(200, 200), new Size(124, 23), 5));
        ...
        class PenTypeGroupBox : GroupBox {
            ...
            public PenTypeGroupBox(PenPropertiesPage owner, Point location, Size size, int tabIndex) {
                ...
                // Add the controls
                this.Controls.Add(new PenButton(this.Owner, new Point(6, 16), new Size(74, 40), 0));
                this.Controls.Add(new HighlighterButton(this.Owner, new Point(82, 16), new Size(74, 40), 1));
        ...
        class PenShapeGroupBox : GroupBox {
            ...
            public PenShapeGroupBox(PenPropertiesPage owner, Point location, Size size, int tabIndex) {
                ...
                this.Controls.Add(new RectangleShapeButton(this.Owner, new Point(83, 16), new Size(75, 40), 1));
        ...
        class ScribbleGroupBox : GroupBox {
            ...
            class ScribblePanel : Panel {
                ...
                public ScribblePanel(PenPropertiesPage owner, Point location, Size size, int tabIndex) {
                    ...
                    // Add the controls
                    this.Controls.Add(new ScribbleClearButton(this, new Point(80, 168), new Size(40, 23), 0));
