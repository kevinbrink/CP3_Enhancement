...
namespace UW.ClassroomPresenter.Viewer.Text
{
    public partial class TextItText : TextBox
    {
        ...
        public bool update_longest_line_ = true;

        private bool width_fixed_ = false;
        ...
        protected override void OnTextChanged(EventArgs e)
        {
            ...
            if (width_fixed_)
            {
                longest_line_width_ = this.Width;
            }
            else
            {
        ...
        {
            longest_line_width_ = 0;
            int limit = ((TextItBox)(this.Parent)).viewer_.SlideWidth - kXMargin_ - ((TextItBox)(this.Parent)).Location.X;
