...
namespace UW.ClassroomPresenter.Viewer.Text
{
    public class TextItBox : PresentItBox
    {
        ...
        protected override void Transform() {
            ...
            textItText1.update_longest_line_ = false;
            textItText1.Font = new Font(slide_font_.Name, slide_font_.Size * scale_y);
        ...
        public override void SaveToSheet() {
            ...
            slide_size_ = new Size(Scale(actual_control_.Width + 10, true, true), Scale(actual_control_.Height, true, false));
        ...
        public override Font Font {
            ...
            set {
                ...
                textItText1.Font = new Font(slide_font_.Name, slide_font_.Size * transform.Elements[3]);
                SaveToSheet();
            }
        }
