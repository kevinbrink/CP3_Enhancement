// $Id: TextSheetModel.cs 1648 2008-07-24 01:24:06Z lamphare $
...
#region Constructors
        ...
        public TextSheetModel(Guid id, Color color) : this(id, null, true,true, new Rectangle(), color, TextStylusModel.GetInstance().DefaultFont) {}
        ...
        public TextSheetModel(Guid id, string text, bool editable, bool is_public, Color c, Rectangle untransformed_bounds, 
        ...
        public TextSheetModel Clone() {
            Rectangle bounds;
            using(Synchronizer.Lock(this.SyncRoot)){
                bounds = this.Bounds;
            }
            return new TextSheetModel(Guid.NewGuid(), text_, is_editable_, public_, bounds, color_, font_);
        }
        ...
        public TextSheetModel(Guid id, string text, bool editable, bool is_public, Rectangle bounds, Color color, Font font) : base(id, SheetDisposition.All, bounds, editable, 0) {
            text_ = text;
    ...
    internal class StatusLabel : TextSheetModel {
        ...
        private StatusLabel(SlideModel slide, string text)
            : base(Guid.NewGuid(), text, false, true,
            new Rectangle(10, 0, text.Length * 12, 12), Color.Red,
            new Font("Arial", 7)) {
